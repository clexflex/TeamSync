...
import { createTeam, getTeams, getTeamById, updateTeam, deleteTeam, getTeamMembers, getManagerTeams, addTeamMember, removeTeamMember, } from "../controllers/teamController.js";
...
router.delete("/:id", verifyUser, verifyRole(["manager", "admin"]), deleteTeam);
